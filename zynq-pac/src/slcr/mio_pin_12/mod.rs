use crate::*;
pub struct MioPin12Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin12Builder {
    value: u32,
}
impl FromBits<u32> for MioPin12Builder {
...
impl RegisterRO<MioPin12Builder, u32> for MioPin12Register {
    fn read(&self) -> MioPin12Builder {
        MioPin12Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin12Builder, u32> for MioPin12Register {
    fn zeroed() -> MioPin12Builder {
        MioPin12Builder::default()
    }
    fn write(&mut self, value: MioPin12Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin12Builder, u32> for MioPin12Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin12Builder) -> MioPin12Builder,
    {
        let value = self.read();
...
impl Default for MioPin12Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
