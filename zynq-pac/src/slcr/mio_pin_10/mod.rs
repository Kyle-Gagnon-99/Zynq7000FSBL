use crate::*;
pub struct MioPin10Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin10Builder {
    value: u32,
}
impl FromBits<u32> for MioPin10Builder {
...
impl RegisterRO<MioPin10Builder, u32> for MioPin10Register {
    fn read(&self) -> MioPin10Builder {
        MioPin10Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin10Builder, u32> for MioPin10Register {
    fn zeroed() -> MioPin10Builder {
        MioPin10Builder::default()
    }
    fn write(&mut self, value: MioPin10Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin10Builder, u32> for MioPin10Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin10Builder) -> MioPin10Builder,
    {
        let value = self.read();
...
impl Default for MioPin10Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
