use crate::*;
pub struct MioPin08Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin08Builder {
    value: u32,
}
impl FromBits<u32> for MioPin08Builder {
...
impl RegisterRO<MioPin08Builder, u32> for MioPin08Register {
    fn read(&self) -> MioPin08Builder {
        MioPin08Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin08Builder, u32> for MioPin08Register {
    fn zeroed() -> MioPin08Builder {
        MioPin08Builder::default()
    }
    fn write(&mut self, value: MioPin08Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin08Builder, u32> for MioPin08Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin08Builder) -> MioPin08Builder,
    {
        let value = self.read();
...
impl Default for MioPin08Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
