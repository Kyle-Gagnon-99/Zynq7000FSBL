use crate::*;
pub struct Fpga1ClkCtrlRegister {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct Fpga1ClkCtrlBuilder {
    value: u32,
}
impl FromBits<u32> for Fpga1ClkCtrlBuilder {
...
impl RegisterRO<Fpga1ClkCtrlBuilder, u32> for Fpga1ClkCtrlRegister {
    fn read(&self) -> Fpga1ClkCtrlBuilder {
        Fpga1ClkCtrlBuilder::from_bits(self.inner.read())
    }
}
impl RegisterWO<Fpga1ClkCtrlBuilder, u32> for Fpga1ClkCtrlRegister {
    fn zeroed() -> Fpga1ClkCtrlBuilder {
        Fpga1ClkCtrlBuilder::default()
    }
    fn write(&mut self, value: Fpga1ClkCtrlBuilder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<Fpga1ClkCtrlBuilder, u32> for Fpga1ClkCtrlRegister {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(Fpga1ClkCtrlBuilder) -> Fpga1ClkCtrlBuilder,
    {
        let value = self.read();
...
impl Default for Fpga1ClkCtrlBuilder {
    fn default() -> Self {
        let mut value: u32 = 0;
