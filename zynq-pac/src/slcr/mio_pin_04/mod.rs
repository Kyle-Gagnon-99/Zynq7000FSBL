use crate::*;
pub struct MioPin04Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin04Builder {
    value: u32,
}
impl FromBits<u32> for MioPin04Builder {
...
impl RegisterRO<MioPin04Builder, u32> for MioPin04Register {
    fn read(&self) -> MioPin04Builder {
        MioPin04Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin04Builder, u32> for MioPin04Register {
    fn zeroed() -> MioPin04Builder {
        MioPin04Builder::default()
    }
    fn write(&mut self, value: MioPin04Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin04Builder, u32> for MioPin04Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin04Builder) -> MioPin04Builder,
    {
        let value = self.read();
...
impl Default for MioPin04Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
