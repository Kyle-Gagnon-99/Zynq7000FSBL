use crate::*;
pub struct MioPin00Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin00Builder {
    value: u32,
}
impl FromBits<u32> for MioPin00Builder {
...
impl RegisterRO<MioPin00Builder, u32> for MioPin00Register {
    fn read(&self) -> MioPin00Builder {
        MioPin00Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin00Builder, u32> for MioPin00Register {
    fn zeroed() -> MioPin00Builder {
        MioPin00Builder::default()
    }
    fn write(&mut self, value: MioPin00Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin00Builder, u32> for MioPin00Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin00Builder) -> MioPin00Builder,
    {
        let value = self.read();
...
impl Default for MioPin00Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
