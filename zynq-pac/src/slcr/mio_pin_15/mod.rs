use crate::*;
pub struct MioPin15Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin15Builder {
    value: u32,
}
impl FromBits<u32> for MioPin15Builder {
...
impl RegisterRO<MioPin15Builder, u32> for MioPin15Register {
    fn read(&self) -> MioPin15Builder {
        MioPin15Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin15Builder, u32> for MioPin15Register {
    fn zeroed() -> MioPin15Builder {
        MioPin15Builder::default()
    }
    fn write(&mut self, value: MioPin15Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin15Builder, u32> for MioPin15Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin15Builder) -> MioPin15Builder,
    {
        let value = self.read();
...
impl Default for MioPin15Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
