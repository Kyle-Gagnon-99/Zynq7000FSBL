use crate::*;
pub struct MioPin07Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin07Builder {
    value: u32,
}
impl FromBits<u32> for MioPin07Builder {
...
impl RegisterRO<MioPin07Builder, u32> for MioPin07Register {
    fn read(&self) -> MioPin07Builder {
        MioPin07Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin07Builder, u32> for MioPin07Register {
    fn zeroed() -> MioPin07Builder {
        MioPin07Builder::default()
    }
    fn write(&mut self, value: MioPin07Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin07Builder, u32> for MioPin07Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin07Builder) -> MioPin07Builder,
    {
        let value = self.read();
...
impl Default for MioPin07Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
