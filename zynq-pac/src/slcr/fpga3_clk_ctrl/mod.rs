use crate::*;
pub struct Fpga3ClkCtrlRegister {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct Fpga3ClkCtrlBuilder {
    value: u32,
}
impl FromBits<u32> for Fpga3ClkCtrlBuilder {
...
impl RegisterRO<Fpga3ClkCtrlBuilder, u32> for Fpga3ClkCtrlRegister {
    fn read(&self) -> Fpga3ClkCtrlBuilder {
        Fpga3ClkCtrlBuilder::from_bits(self.inner.read())
    }
}
impl RegisterWO<Fpga3ClkCtrlBuilder, u32> for Fpga3ClkCtrlRegister {
    fn zeroed() -> Fpga3ClkCtrlBuilder {
        Fpga3ClkCtrlBuilder::default()
    }
    fn write(&mut self, value: Fpga3ClkCtrlBuilder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<Fpga3ClkCtrlBuilder, u32> for Fpga3ClkCtrlRegister {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(Fpga3ClkCtrlBuilder) -> Fpga3ClkCtrlBuilder,
    {
        let value = self.read();
...
impl Default for Fpga3ClkCtrlBuilder {
    fn default() -> Self {
        let mut value: u32 = 0;
