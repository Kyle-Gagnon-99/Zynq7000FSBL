use crate::*;
pub struct Fpga0ClkCtrlRegister {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct Fpga0ClkCtrlBuilder {
    value: u32,
}
impl FromBits<u32> for Fpga0ClkCtrlBuilder {
...
impl RegisterRO<Fpga0ClkCtrlBuilder, u32> for Fpga0ClkCtrlRegister {
    fn read(&self) -> Fpga0ClkCtrlBuilder {
        Fpga0ClkCtrlBuilder::from_bits(self.inner.read())
    }
}
impl RegisterWO<Fpga0ClkCtrlBuilder, u32> for Fpga0ClkCtrlRegister {
    fn zeroed() -> Fpga0ClkCtrlBuilder {
        Fpga0ClkCtrlBuilder::default()
    }
    fn write(&mut self, value: Fpga0ClkCtrlBuilder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<Fpga0ClkCtrlBuilder, u32> for Fpga0ClkCtrlRegister {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(Fpga0ClkCtrlBuilder) -> Fpga0ClkCtrlBuilder,
    {
        let value = self.read();
...
impl Default for Fpga0ClkCtrlBuilder {
    fn default() -> Self {
        let mut value: u32 = 0;
