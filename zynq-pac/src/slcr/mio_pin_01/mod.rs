use crate::*;
pub struct MioPin01Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin01Builder {
    value: u32,
}
impl FromBits<u32> for MioPin01Builder {
...
impl RegisterRO<MioPin01Builder, u32> for MioPin01Register {
    fn read(&self) -> MioPin01Builder {
        MioPin01Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin01Builder, u32> for MioPin01Register {
    fn zeroed() -> MioPin01Builder {
        MioPin01Builder::default()
    }
    fn write(&mut self, value: MioPin01Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin01Builder, u32> for MioPin01Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin01Builder) -> MioPin01Builder,
    {
        let value = self.read();
...
impl Default for MioPin01Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
