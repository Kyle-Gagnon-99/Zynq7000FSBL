use crate::*;
pub struct MioPin11Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin11Builder {
    value: u32,
}
impl FromBits<u32> for MioPin11Builder {
...
impl RegisterRO<MioPin11Builder, u32> for MioPin11Register {
    fn read(&self) -> MioPin11Builder {
        MioPin11Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin11Builder, u32> for MioPin11Register {
    fn zeroed() -> MioPin11Builder {
        MioPin11Builder::default()
    }
    fn write(&mut self, value: MioPin11Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin11Builder, u32> for MioPin11Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin11Builder) -> MioPin11Builder,
    {
        let value = self.read();
...
impl Default for MioPin11Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
