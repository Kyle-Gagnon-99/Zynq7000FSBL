use crate::*;
pub struct MioPin05Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin05Builder {
    value: u32,
}
impl FromBits<u32> for MioPin05Builder {
...
impl RegisterRO<MioPin05Builder, u32> for MioPin05Register {
    fn read(&self) -> MioPin05Builder {
        MioPin05Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin05Builder, u32> for MioPin05Register {
    fn zeroed() -> MioPin05Builder {
        MioPin05Builder::default()
    }
    fn write(&mut self, value: MioPin05Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin05Builder, u32> for MioPin05Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin05Builder) -> MioPin05Builder,
    {
        let value = self.read();
...
impl Default for MioPin05Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
