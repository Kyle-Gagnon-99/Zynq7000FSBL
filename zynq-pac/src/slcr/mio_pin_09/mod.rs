use crate::*;
pub struct MioPin09Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin09Builder {
    value: u32,
}
impl FromBits<u32> for MioPin09Builder {
...
impl RegisterRO<MioPin09Builder, u32> for MioPin09Register {
    fn read(&self) -> MioPin09Builder {
        MioPin09Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin09Builder, u32> for MioPin09Register {
    fn zeroed() -> MioPin09Builder {
        MioPin09Builder::default()
    }
    fn write(&mut self, value: MioPin09Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin09Builder, u32> for MioPin09Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin09Builder) -> MioPin09Builder,
    {
        let value = self.read();
...
impl Default for MioPin09Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
