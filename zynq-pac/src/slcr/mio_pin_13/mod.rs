use crate::*;
pub struct MioPin13Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin13Builder {
    value: u32,
}
impl FromBits<u32> for MioPin13Builder {
...
impl RegisterRO<MioPin13Builder, u32> for MioPin13Register {
    fn read(&self) -> MioPin13Builder {
        MioPin13Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin13Builder, u32> for MioPin13Register {
    fn zeroed() -> MioPin13Builder {
        MioPin13Builder::default()
    }
    fn write(&mut self, value: MioPin13Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin13Builder, u32> for MioPin13Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin13Builder) -> MioPin13Builder,
    {
        let value = self.read();
...
impl Default for MioPin13Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
