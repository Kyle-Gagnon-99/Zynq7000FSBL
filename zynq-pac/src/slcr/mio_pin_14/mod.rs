use crate::*;
pub struct MioPin14Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin14Builder {
    value: u32,
}
impl FromBits<u32> for MioPin14Builder {
...
impl RegisterRO<MioPin14Builder, u32> for MioPin14Register {
    fn read(&self) -> MioPin14Builder {
        MioPin14Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin14Builder, u32> for MioPin14Register {
    fn zeroed() -> MioPin14Builder {
        MioPin14Builder::default()
    }
    fn write(&mut self, value: MioPin14Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin14Builder, u32> for MioPin14Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin14Builder) -> MioPin14Builder,
    {
        let value = self.read();
...
impl Default for MioPin14Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
