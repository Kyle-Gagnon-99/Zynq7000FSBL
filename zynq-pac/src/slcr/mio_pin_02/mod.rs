use crate::*;
pub struct MioPin02Register {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct MioPin02Builder {
    value: u32,
}
impl FromBits<u32> for MioPin02Builder {
...
impl RegisterRO<MioPin02Builder, u32> for MioPin02Register {
    fn read(&self) -> MioPin02Builder {
        MioPin02Builder::from_bits(self.inner.read())
    }
}
impl RegisterWO<MioPin02Builder, u32> for MioPin02Register {
    fn zeroed() -> MioPin02Builder {
        MioPin02Builder::default()
    }
    fn write(&mut self, value: MioPin02Builder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<MioPin02Builder, u32> for MioPin02Register {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(MioPin02Builder) -> MioPin02Builder,
    {
        let value = self.read();
...
impl Default for MioPin02Builder {
    fn default() -> Self {
        let mut value: u32 = 0;
...
impl MioPin02Builder {
    ...
    pub fn disable_rcrv(&self) -> bool {
        self.value.get_bit(13usize)
    }
    pub fn with_disable_rcrv(mut self, value: bool) -> Self {
