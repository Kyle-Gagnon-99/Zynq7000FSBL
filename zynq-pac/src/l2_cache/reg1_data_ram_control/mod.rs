use crate::*;
pub struct Reg1DataRamControlRegister {
    inner: volatile_register::RW<u32>,
}
#[derive(Debug, Clone, Copy)]
pub struct Reg1DataRamControlBuilder {
    value: u32,
}
impl FromBits<u32> for Reg1DataRamControlBuilder {
...
impl RegisterRO<Reg1DataRamControlBuilder, u32> for Reg1DataRamControlRegister {
    fn read(&self) -> Reg1DataRamControlBuilder {
        Reg1DataRamControlBuilder::from_bits(self.inner.read())
    }
}
impl RegisterWO<Reg1DataRamControlBuilder, u32> for Reg1DataRamControlRegister {
    fn zeroed() -> Reg1DataRamControlBuilder {
        Reg1DataRamControlBuilder::default()
    }
    fn write(&mut self, value: Reg1DataRamControlBuilder) {
        unsafe {
            self.inner.write(value.into_bits());
        }
    }
}
impl RegisterRW<Reg1DataRamControlBuilder, u32> for Reg1DataRamControlRegister {
    fn modify<F>(&mut self, f: F)
    where
        F: FnOnce(Reg1DataRamControlBuilder) -> Reg1DataRamControlBuilder,
    {
        let value = self.read();
...
impl Default for Reg1DataRamControlBuilder {
    fn default() -> Self {
        let mut value: u32 = 0;
...
impl Reg1DataRamControlBuilder {
